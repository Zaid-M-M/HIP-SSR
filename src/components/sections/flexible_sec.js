                    ...
                    <Slider {...flex_slider} className='park_main_slider other_park_slider ahmedabad_oth_slider flex_main_slider horz_sld'>
                        ...
                        <div className='flex_sld_outer'>
                            <div className='flex_sld_inner'>
                                <img className='flex_bg_img' src={require('../../assets/img/customised_structural.jpg')}></img>
                        ...
                        <div className='flex_sld_outer'>
                            <div className='flex_sld_inner'>
                                <img className='flex_bg_img' src={require('../../assets/img/Complex_utility.jpg')}></img>
                                <div className='flex_content'>
                        ...
                        <div className='flex_sld_outer'>
                            <div className='flex_sld_inner'>
                                <img className='flex_bg_img' src={require('../../assets/img/Roof_wall.jpg')}></img>
                                <div className='flex_content'>
                        ...
                        <div className='flex_sld_outer'>
                            <div className='flex_sld_inner'>
                                <img className='flex_bg_img' src={require('../../assets/img/Temperature_controlled.jpg')}></img>
                                <div className='flex_content'>
                        ...
                        <div className='flex_sld_outer'>
                            <div className='flex_sld_inner'>
                                <img className='flex_bg_img' src={require('../../assets/img/Combination_of _forced.jpg')}></img>
                                <div className='flex_content'>
