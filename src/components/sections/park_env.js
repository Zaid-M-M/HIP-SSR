            ...
            <div className='row img-grid'>
              ...
              <div className='col-lg-4 col-md-6 col-12 guttr-spc'>
                  <div className='img-clm'>
                    ...
                    <div className='img-content'>
                      <h2>Pan India presence</h2><img className="toggl-icon" src={require('../../assets/img/svg/close_icon.svg').default}></img>
              ...
              <div className='col-lg-4 col-md-6 col-12 guttr-spc'>
                  <div className='img-clm'>
                    ...
                    <div className='img-content'>
                      <h2>Scalability</h2><img className="toggl-icon" src={require('../../assets/img/svg/close_icon.svg').default}></img>
              ...
              <div className='col-lg-4 col-md-6 col-12 guttr-spc'>
                  <div className='img-clm'>
                    ...
                    <div className='img-content'>
                      <h2>Efficiency</h2><img className="toggl-icon" src={require('../../assets/img/svg/close_icon.svg').default}></img>
            ...
            {/* <div className='row img-grid no-padding'> */}
              <div className='col-lg-4 col-md-6 col-12 guttr-spc'>
                <div className='img-clm'>
                    ...
                    <div className='img-content'>
                      <h2>Fully compliant</h2><img className="toggl-icon" src={require('../../assets/img/svg/close_icon.svg').default}></img>
              ...
              <div className='col-lg-4 col-md-6 col-12 guttr-spc'>
                <div className='img-clm'>
                    ...
                    <div className='img-content'>
                      <h2>Sustainability</h2><img className="toggl-icon" src={require('../../assets/img/svg/close_icon.svg').default}></img>
              ...
              <div className='col-lg-4 col-md-6 col-12 guttr-spc'>
                  <div className='img-clm'>
                    ...
                    <div className='img-content'>
                      <h2>Safety and security</h2><img className="toggl-icon" src={require('../../assets/img/svg/close_icon.svg').default}></img>
