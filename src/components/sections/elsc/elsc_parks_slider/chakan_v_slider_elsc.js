    ...
    <>
      ...
      {/* ------------------------------ Parks Image popup code ------------------------------ */}
        ...
        <div className='prk_img_popup' id='div22'>
            ...
            <img className='elsc_park_map_img ' src={require('../../../../assets/img/elsc_landing_pg/chakan_v_map/popup_img/Block_1.jpg')}></img>
        </div>
        ...
        <div className='prk_img_popup' id='div23'>
            ...
            <img className='elsc_park_map_img ' src={require('../../../../assets/img/elsc_landing_pg/chakan_v_map/popup_img/Block_2.jpg')}></img>
        </div>
        ...
        <div className='prk_img_popup' id='div24'>
            ...
            <img className='elsc_park_map_img ' src={require('../../../../assets/img/elsc_landing_pg/chakan_v_map/popup_img/Block_3.jpg')}></img>
        </div>
        ...
        <div className='prk_img_popup' id='div25'>
            ...
            <img className='elsc_park_map_img ' src={require('../../../../assets/img/elsc_landing_pg/chakan_v_map/popup_img/Block_4.jpg')}></img>
        </div>
        ...
        <div className='prk_img_popup' id='div26'>
            ...
            <img className='elsc_park_map_img ' src={require('../../../../assets/img/elsc_landing_pg/chakan_v_map/popup_img/Block_5.jpg')}></img>
        </div>
