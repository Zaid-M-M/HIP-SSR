  ...
  return (
    <>
      ...
      <div className='prk_img_popup' id='div6'>
        ...
        <img className='elsc_park_map_img ' src={require('../../../../assets/img/elsc_landing_pg/Delhi_I_map/popup_img/Block_A.jpg')}></img>
      </div>
      ...
      <div className='prk_img_popup' id='div7'>
        ...
        <img className='elsc_park_map_img ' src={require('../../../../assets/img/elsc_landing_pg/Delhi_I_map/popup_img/Delhi_I_Block_C.jpg')}></img>
      </div>
