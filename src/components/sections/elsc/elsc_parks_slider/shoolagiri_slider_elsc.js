    ...
    <>
      ...
      {/* ------------------------------ Parks Image popup code ------------------------------ */}
        ...
        <div className='prk_img_popup' id='div19'>
            ...
            <img className='elsc_park_map_img ' src={require('../../../../assets/img/elsc_landing_pg/Hosur_map/popup_img/Block_B.jpg')}></img>
        </div>
        ...
        <div className='prk_img_popup' id='div20'>
            ...
            <img className='elsc_park_map_img ' src={require('../../../../assets/img/elsc_landing_pg/Hosur_map/popup_img/Block_D.jpg')}></img>
        </div>
        ...
        <div className='prk_img_popup' id='div21'>
            ...
            <img className='elsc_park_map_img ' src={require('../../../../assets/img/elsc_landing_pg/Hosur_map/popup_img/Block_C.jpg')}></img>
        </div>
