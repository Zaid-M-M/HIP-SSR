  ...
  return (
    <>
      ...
      <div className='prk_img_popup' id='div9'>
        ...
        <img className='elsc_park_map_img ' src={require('../../../../assets/img/elsc_landing_pg/Bilaspur_II_map/popup_img/Block_1.jpg')}></img>
      </div>
      ...
      <div className='prk_img_popup' id='div10'>
        ...
        <img className='elsc_park_map_img ' src={require('../../../../assets/img/elsc_landing_pg/Bilaspur_II_map/popup_img/Block_2.jpg')}></img>
      </div>
