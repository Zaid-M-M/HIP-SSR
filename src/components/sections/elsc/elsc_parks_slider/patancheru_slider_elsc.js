    ...
    <>
      ...
      {/* ------------------------------ Parks Image popup code ------------------------------ */}
        ...
        <div className='prk_img_popup' id='div17'>
            ...
            <img className='elsc_park_map_img ' src={require('../../../../assets/img/elsc_landing_pg/Patancheru_map/popup_img/Block_B.jpg')}></img>
        </div>
        ...
        <div className='prk_img_popup' id='div18'>
            ...
            <img className='elsc_park_map_img ' src={require('../../../../assets/img/elsc_landing_pg/Patancheru_map/popup_img/Block_D.jpg')}></img>
        </div>
