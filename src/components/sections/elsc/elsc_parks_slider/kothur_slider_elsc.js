    ...
    <>
      ...
      {/* ------------------------------ Parks Image popup code ------------------------------ */}
        ...
        <div className='prk_img_popup' id='div11'>
            ...
            <img className='elsc_park_map_img ' src={require('../../../../assets/img/elsc_landing_pg/Kothur_map/popup_img/Block_A.jpg')}></img>
        </div>
        ...
        <div className='prk_img_popup' id='div12'>
            ...
            <img className='elsc_park_map_img ' src={require('../../../../assets/img/elsc_landing_pg/Kothur_map/popup_img/Block_B.jpg')}></img>
        </div>
        ...
        <div className='prk_img_popup' id='div13'>
            ...
            <img className='elsc_park_map_img ' src={require('../../../../assets/img/elsc_landing_pg/Kothur_map/popup_img/Block_C.jpg')}></img>
        </div>
        ...
        <div className='prk_img_popup' id='div14'>
            ...
            <img className='elsc_park_map_img ' src={require('../../../../assets/img/elsc_landing_pg/Kothur_map/popup_img/Block_D.jpg')}></img>
        </div>
        ...
        <div className='prk_img_popup' id='div15'>
            ...
            <img className='elsc_park_map_img ' src={require('../../../../assets/img/elsc_landing_pg/Kothur_map/popup_img/Block_E.jpg')}></img>
        </div>
        ...
        <div className='prk_img_popup' id='div16'>
            ...
            <img className='elsc_park_map_img ' src={require('../../../../assets/img/elsc_landing_pg/Kothur_map/popup_img/Block_F.jpg')}></img>
        </div>
