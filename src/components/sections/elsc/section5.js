                  ...
                  <div className='custm_outer_sld'>
                      <div className='cs_custm_inner'>
                          ...
                          <div className='content_div'>
                              ...
                              <a href={require('../../../assets/pdf/Bentler.pdf')}  className="download_btn" download><img src={require('../../../assets/img/svg/elsc_landing/pdf_icon.svg').default}></img>Donwload</a>
                  ...
                  <div className='custm_outer_sld'>
                      <div className='cs_custm_inner'>
                          ...
                          <div className='content_div'>
                              ...
                              <a href={require('../../../assets/pdf/3PL_player.pdf')}  className="download_btn" download><img src={require('../../../assets/img/svg/elsc_landing/pdf_icon.svg').default}></img>Donwload</a>
                              <div class="section5_cc_ovrly"></div>
                          </div>
                  ...
                  <div className='custm_outer_sld'>
                      <div className='cs_custm_inner'>
                          ...
                          <div className='content_div'>
                              ...
                              <a href={require('../../../assets/pdf/Fosroc.pdf')} className="download_btn" download><img src={require('../../../assets/img/svg/elsc_landing/pdf_icon.svg').default}></img>Donwload</a>
                              <div class="section5_cc_ovrly"></div>
                          </div>
