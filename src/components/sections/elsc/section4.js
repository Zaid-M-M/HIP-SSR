          ...
          <div className="row no_LR_margin">
            ...
            <div className="col-lg-3 col-md-6 col-12 no_padding">
              <div className="solutions_bx sol_bx1">
                <div className="solutions_bx_inner">
                  <img src={require('../../../assets/img/svg/elsc_landing/strategic_land_elsc.svg').default}></img>
            ...
            <div className="col-lg-3 col-md-6 col-12 no_padding">
              <div className="solutions_bx sol_bx2">
                <div className="solutions_bx_inner">
                  <img src={require('../../../assets/img/svg/elsc_landing/prk_compliance_elsc.svg').default}></img>
                  <div className="sbi_one">
            ...
            <div className="col-lg-3 col-md-6 col-12 no_padding">
              <div className="solutions_bx sol_bx3">
                <div className="solutions_bx_inner">
                  <img src={require('../../../assets/img/svg/elsc_landing/project_dev_elsc.svg').default}></img>
                  <div className="sbi_one">
            ...
            <div className="col-lg-3 col-md-6 col-12 no_padding">
              <div className="solutions_bx">
                <div className="solutions_bx_inner">
                  <img src={require('../../../assets/img/svg/elsc_landing/op_assets_manage_elsc.svg').default}></img>
                  <div className="sbi_one">
