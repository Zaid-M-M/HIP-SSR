                ...
                <div className='cstm_container '>
                    ...
                    <div className='row'>
                        ...
                        <div className='col-lg-3 col-md-3 col-12 enq_col'>
                            <a className='cta_btn p_opacity enq_bnt' ref={cta_aniamtion} id='cta_aniamtion'>Enquire Now <span><img src={require('../../assets/img/svg/sldr_right_arrow_blk.svg').default}></img></span></a>
                        </div>
                    </div>
